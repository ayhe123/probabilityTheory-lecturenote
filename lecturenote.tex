...
\fancypagestyle{fancy-license-info}{%
  \fancyhf{}
  \fancyfoot[L]{
    \includegraphics[scale=.5]{license.eps}\hspace{.5em}
    \begin{minipage}[b][4ex][t]{25em}
        \footnotesize{笔记发布在\href{https://github.com/ayhe123/probabilityTheory-lecturenote}{\color{blue}这里}\\
        本笔记采用 CC-BY-4.0 许可证, 更多信息见\href{https://creativecommons.org/licenses/by/4.0}{\color{blue}这里}}
    \end{minipage}}
