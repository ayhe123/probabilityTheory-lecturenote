...
\fancypagestyle{fancy-license-info}{%
  \fancyhf{}
  \fancyfoot[L]{
    \href{https://creativecommons.org/licenses/by/4.0}{\includegraphics[scale=.5]{license.eps}}\hspace{.5em}
    \begin{minipage}[b][4ex][t]{30em}
        \footnotesize{笔记发布在: \url{https://github.com/ayhe123/probabilityTheory-lecturenote}\\
        本笔记采用 CC-BY-4.0 许可证, 点击左边的图标查看更多信息}
    \end{minipage}}
